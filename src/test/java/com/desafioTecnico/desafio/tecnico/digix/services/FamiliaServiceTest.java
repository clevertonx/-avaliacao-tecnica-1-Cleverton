...
public class FamiliaServiceTest {
    ...
    public void testListarFamiliasOrdenadasPorPontuacao() {
        ...
        List<FamiliaDTO> expectedFamiliaDTOs = new ArrayList<>();
        expectedFamiliaDTOs.add(new FamiliaDTO(1500.0, 3, pontuacaoFamilia2));
        expectedFamiliaDTOs.add(new FamiliaDTO(1000.0, 2, pontuacaoFamilia1));
        expectedFamiliaDTOs.add(new FamiliaDTO(2000.0, 1, pontuacaoFamilia3));

        familiaRepository.save(familia1);
        familiaRepository.save(familia2);
        familiaRepository.save(familia3);

        List<FamiliaDTO> atualFamiliaDTOs = familiaService.listarFamiliasOrdenadasPorPontuacao();
